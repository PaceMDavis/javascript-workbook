...
const stringsToNumbs = (numbers) => {
  let arrNums = [];
  numbers.forEach(function(current, index, arr) {
    arrNums.push(Number(current));
  });
...
let numberArray = stringsToNumbs(strNums); //expect an array of the digits as numbers
